...
class FurnitureListView extends StatelessWidget {
  ...
  final Function(HomeDecore furniture)? onTap;
  final List<HomeDecore> furnitureList;
  ...
  Widget _furnitureScore(HomeDecore furniture) {
    return Row(
      children: [
  ...
  Widget _listViewItem(HomeDecore furniture, int index) {
    Widget widget;
    ...
    return isHorizontal == true
        ? SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, index) {
                HomeDecore furniture = furnitureList[index];
